...
public class ExampleReadListener extends AnalysisEventListener<Map<Integer, String>> {
	 ...
	 * @param dao
	 */
	public ExampleReadListener(SaveExcelDao dao) {
		if (dao == null) {
	...
	private void saveData() {
		...
		saveExcelDao.insertMapBatch(datas);
	}
